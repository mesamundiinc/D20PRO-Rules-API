...
public class EsperGenesisRules extends AbstractRules
{
  private static final Logger lg = Logger.getLogger(EsperGenesisRules.class);

  protected EsperGenesisRules()
  {
    super();
  }
  ...
  public enum GameSystem
  {
    ...
    {
      return GameSystem.EsperGenesis;
    }
  }
...
//        base = Math.ceil(level * .25);
  ...
  public static class Spell
  {
    ...
    /**
     *  The code fragment below is the current list of possible Spell usage configurations for a specified class.
     *  To use this fragment, copy it and
      */
//    public static final String[] _SPELL_TABS = { "Spells Prepared", "Spells Known", "Domain" };
//    public static final byte[]   _SPELL_UI = { PREPARED, KNOWN, SPECIAL, SLOTS };
//    public static final boolean  _5E_PREPARED = true;
//    public static final byte     _MAX_DOMAIN_SPELLS = 18;
//    public static final float    _DOMAIN_SPELL_RATE = 0.5f;
//    public static final byte     _DOMAIN_SPELLS_PER_LEVEL = 2;
//    public static final byte     _DOMAIN_MIN_LEVEL = 1;
//    public static final byte     _DOMAIN_MAX_LEVEL = 5;

    /**
     * Engineers map Cantrips to Prime Talents and Spells to Techniques. The chosen specialty uses 5e domain
     * mechanics.
     */
    // ENGINEER
    public static final String[] ENGINEER_SPELL_TABS = { "Techniques", "Specialty" };
    public static final byte[]   ENGINEER_SPELL_UI = { PREPARED, SPECIAL, SLOTS };
    public static final boolean  ENGINEER_5E_PREPARED = true;
    public static final byte     ENGINEER_MAX_DOMAIN_SPELLS = 18;
    public static final float    ENGINEER_DOMAIN_SPELL_RATE = 0.5f;
    public static final byte     ENGINEER_DOMAIN_SPELLS_PER_LEVEL = 2;
    public static final byte     ENGINEER_DOMAIN_MIN_LEVEL = 1;
    public static final byte     ENGINEER_DOMAIN_MAX_LEVEL = 5;

    // HUNTER
    public static final String[] HUNTER_SPELL_TABS = { "Techniques", "Known", "Archetype" };
    public static final byte[]   HUNTER_SPELL_UI = { PREPARED, KNOWN, SLOTS };
    public static final boolean  HUNTER_5E_PREPARED = true;

    // MELDER | Casting for a Melder is done via Traits and Pools
    public static final String[] MELDER_SPELL_TABS = { "Prepared", "Known" };
    public static final byte[]   MELDER_SPELL_UI = { PREPARED, KNOWN, SLOTS };
    public static final boolean  MELDER_5E_PREPARED = true;

    // SENTINEL
    public static final String[] SENTINEL_SPELL_TABS = { "Techniques", "Path" };
    public static final byte[]   SENTINEL_SPELL_UI = { PREPARED, KNOWN, SPECIAL, SLOTS };
    public static final boolean  SENTINEL_5E_PREPARED = true;
    public static final byte     SENTINEL_MAX_DOMAIN_SPELLS = 18;
    public static final float    SENTINEL_DOMAIN_SPELL_RATE = 0.5f;
    public static final byte     SENTINEL_DOMAIN_SPELLS_PER_LEVEL = 2;
    public static final byte     SENTINEL_DOMAIN_MIN_LEVEL = 1;
    public static final byte     SENTINEL_DOMAIN_MAX_LEVEL = 5;

    // SPECIALIST
    public static final String[] SPECIALIST_SPELL_TABS = { "Prepared", "Known" };
    public static final byte[]   SPECIALIST_SPELL_UI = { PREPARED, KNOWN, SLOTS };
    public static final boolean  SPECIALIST_5E_PREPARED = true;

    // WARRIOR
    public static final String[] WARRIOR_SPELL_TABS = { "Prepared", "Known" };
    public static final byte[]   WARRIOR_SPELL_UI = { PREPARED, KNOWN, SLOTS };
    public static final boolean  WARRIOR_5E_PREPARED = true;

    // GENERIC
    public static final String[] GENERIC_SPELL_TABS = { "Prepared", "Known", "Special" };
    ...
    public static final byte     GENERIC_MAX_DOMAIN_SPELLS = 18;
    public static final float    GENERIC_DOMAIN_SPELL_RATE = 0.5f;
    public static final byte     GENERIC_DOMAIN_SPELLS_PER_LEVEL = 2;
    public static final byte     GENERIC_DOMAIN_MIN_LEVEL = 1;
    public static final byte     GENERIC_DOMAIN_MAX_LEVEL = 5;
