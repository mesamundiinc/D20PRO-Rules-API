 ...
 * @author owlbear
 */
public class ThreeFiveRules extends AbstractRules
{
  public ThreeFiveRules()
  {
    super();
  }
  ...
  public static class AC // implements Constants_ArmorClass
  {
    ...
    public static final String[] NAMES = { "Natural", "Armor", "Shield", "Deflect", "Enhancement", "Dodge" }; // ,
                                                                                                              // "Luck"
                                                                                                              // };

    public static final String[] LABELS = { "Base", "plus", "Armor", "plus", "Shield", "plus", "Natural", "Dex", "plus",
        "Size", "plus", "Deflect", "plus", "Unnamed", "plus", "Dodge", "and", "Max Dex" };
  ...
  public static class Attack implements java.io.Serializable
  {
    ...
    {
      String[] defenses = AttackOptionsMemory.NAMES;
      ...
      if (null != customDefenses)
      {
        ...
        System.arraycopy(customDefenses, 0, defenses, AttackOptionsMemory.NAMES.length - 1, customDefenses.length);
      }
      else
  ...
  public static class Save
  {
    ...
    public static final byte EVASION_SAVE = REF; // the saving throw index to
                                                 // check for evasion
  ...
  {
    public static final String[] NAMES = { "Unknown", "Aberration", "Animal", "Construct", "Dragon", "Dwarves",
        "Elemental", "Elves", "Fey", "Giant", "Gnomes", "Half-Elves", "Half-Orcs", "Halflings", "Human", "Humanoid",
        "Magical Beast", "M. Humanoid", "Ooze", "Outsider", "Plant", "Undead", "Vermin" };
  ...
  public static class CreatureClass
  {
    ...
    // Backward compatibility check to see if a creature is sporting legacy
    // stats.
    public void checkHistorical(CreatureTemplate template)
    {
      ...
      // historical is defined as a creature made in a version older then
      // 3.6.6.x
      // Attempt to use embedded version numbers in creatures to detected if a
      // ctr is historical
  ...
  public static class Spell
  {
    ...
    public static final byte DRUID_DOMAIN_MAX_LEVEL = 9;
    ...
    public static final byte PALADIN_DOMAIN_MAX_LEVEL = 9;
  ...
  public static class Usage
  {
    ...
    public static final byte PER_ROLL = 4;
    public static final byte SPELL_POOL = 5; // handler for spell slots

    public static final String[] NAMES = { "At Will", "Per Day", "Per Init", "Charge", "Recharge" };
  }
  ...
  public static class Actions
  {
    ...
    static
    {
      ...
      Input.add("none");
      ATTACK_QUALITIES.LIST.forEach(q -> Input.add((String) q));
      Collections.sort(Input);
      ACTIONS_MAP.put("Effect", Input);

      ArrayList<String> Input1 = new ArrayList<String>();
      Input1.add("None");
      ATTACK_QUALITIES.CONDITIONS.forEach(q -> Input1.add((String) q));
  ...
  public static class DR
  {
    ...
    static
    {
      LIST = new ArrayList<>(); // inital capacity (to prevent resizing on each
                                // add)
  ...
  //
  // _toggleD = LAF.ToggleButton.png( "toggleD", new ABToggleButtonAction( _tad,
  // new ToggleADDisableAction() ));
  // _toggleD.setToolTipText("Enable and toggle Advantage/Disadvantage");
  // _toggleD.setVisible(false);
  // _toggleD.setEnabled(false);
  //
  // _toggleA = LAF.ToggleButton.png( "toggleA", new ABToggleButtonAction(
  // _toggleD, new ToggleDisadvantageAction() ) );
  // _toggleA.setToolTipText("Enable and toggle Advantage/Disadvantage");
  // _toggleA.setVisible(false);
  // _toggleA.setEnabled(false);
  //
  // _toggleAD = LAF.ToggleButton.png( "toggleAD", new ABToggleButtonAction(
  // _toggleA, new ToggleAdvantageAction() ) );
  ...
  //// accessPreferences().accessBoolean( KEY_HAS_ADVANTAGE, false);
  //// accessPreferences().accessBoolean( KEY_HAS_DISADVANTAGE, true);
  // }
  //
  // }
  //
  ...
  //// accessPreferences().accessBoolean( KEY_HAS_ADVANTAGE, true);
  //// accessPreferences().accessBoolean( KEY_HAS_DISADVANTAGE, false);
  // }
  //
  // }
  ...
  public final class D20PreferencesModel_AddOn extends D20PreferencesModel
  {
    ...
    public D20PreferencesModel_AddOn()
    {
      ...
      assignBoolean(KEY_REQUIRES_RESTART, false);
